...
// header for create single sprite
#include "Sprite.hpp"
// grouping singles sprite to group
...
bool InitializeSDL()
{
  ...
  if ( initResult )
    {
      cout << "Failed to initalize SDL: " << SDL_GetError() << endl;
      return false;
    }
}
